...
<form id="exam_timetable_form" action="http://localhost/cloud/examination/subjectreportlist" method="POST">
...
<?php Utility::submitButton('view_reports','view_reports','View Reports'); ?></td>
</div>
</form>
</div>
