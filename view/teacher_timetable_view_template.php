...
{
$html.='<div class="timetable_box" id="'.$timetable[$k].'" style="background:'.Utility::getColor(($timetable[$k])%8).'" >'.$section[$timetable[$k]].'</div>';
}
$html.='</td>';
echo $html;
$k++;
...
{
echo '<tr><td>'.$section[$key]." : </td><td>".$value." Hours</td></tr>";
}
