...
<?php
$highlight='employee_profile';
include('employee_menu.php');
?>


<div class="content_heading" style="width:400px;">
<img class="content_heading_image" src="http://localhost/cloud/images/profile.png">
<div class="content_description" >Employee Profile</div>
</div>
...
<a href="http://localhost/cloud/teacher/confirm"><button class="yellow_btn">Edit</button></a>
<a href="http://localhost/cloud/teacher/makepdf"><button class="submit_btn">Generate Appointment Order</button></a>
</div>
